                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                        $ambil= mysqli_query($conn,"select * from barangkeluar");
                                        $i=1;
                                        ...
                                        <form method="post">
                                            <div class="modal-body">
                                                ...
                                                <input type="number" name="stockkeluar" value="<?=$stock;?>" class="form-control" required></br>
        ...
        <div class="modal fade" id="myModal">
            ...
            <form method="post">
                <div class="modal-body">
                    ...
                    <input type="number" name="stockkeluar" placeholder="Stock Barang" class="form-control" required></br>
                    ...
                    <button type="submit" class="btn btn-primary" name="barangkeluar">Tambah Barang</button>
